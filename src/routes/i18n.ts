...
export default createI18nStore<IndexPage>({
	vi: {
		greetings: 'Xin chào!!',
		introduction: 'Mình là Cmb, mình thích sáng tạo và tiêu thụ',
		whatICreate:
			'Về những thứ mình tạo ra, vào thời gian rảnh ngoài việc xem youtube tối ngày mình có thể sẽ vẽ, làm nhạc hoặc lập trình',
		dontExpectQuality:
			'Chất lượng của thứ mình tạo ra có thể sẽ không được hoàn hảo cho lắm do mình là một người đi ngược lại với câu "1 nghề cho chín còn hơn 9 nghề" nhưng hi vọng các bạn vẫn tìm được thứ gì đó thú vị từ các sản phẩm của mình!',
		ideaToReality: 'Khi có ý tưởng nào đó khiến nổi hứng lên, ăn ngủ không yên thì mình sẽ cố biến nó thành sự thật!!',
		checkOutMyStuff: 'Các bạn có thể xem những thứ mình đã làm tại:'
	},
	en: {
		greetings: 'Hi there!!',
		...
		checkOutMyStuff: 'You can check out my stuff at:'
	}
});
